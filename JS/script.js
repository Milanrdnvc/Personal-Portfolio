...
gsap.from('.services__skill', {scrollTrigger: {trigger: '.services__skill', toggleActions: 'restart reverse restart reverse', start: 'top 90%', end: 'top 10%'}, y: '30%', opacity: 0, ease: 'power4', duration: 1, stagger: .05});
